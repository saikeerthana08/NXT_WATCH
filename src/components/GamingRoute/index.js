  ...
  renderGamingVideos = () => (
    <CartContext.Consumer>
      {value => {
        ...
        const changeIconColor = isDarkTheme ? '#ff0000' : '#000000'

        return (
          <SearchVideosContainer data-testid="gaming" bgColor={bgColor}>
            <GaminHeaderContainer color={textColor}>
              <GamingLogo bgColor={bgColor}>
                <SiYoutubegaming size={22} color={changeIconColor} />
              </GamingLogo>
